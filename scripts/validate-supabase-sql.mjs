...
const assertions = [
  ...
  [realtimePush.indexOf("add column if not exists updated_at timestamptz") < realtimePush.indexOf("select recipient_id, p.id, p.status, p.updated_at"), "Realtime freshness setup precedes the partnership state backfill"],
